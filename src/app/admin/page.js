            ...
            <div className="rounded-xl border border-line bg-surface-card p-4">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2">
                {[
                  ...
                  { href: '/app/campagnes',    label: 'Prospection',   icon: ListChecks,  color: 'teal',    desc: 'Listes + dogfood' },
                  { href: '/app/formulaires',          label: 'Forms',         icon: Newspaper,   color: 'cyan',    desc: 'Formulaires' },
