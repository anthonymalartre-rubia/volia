...
function NewCampaignContent() {
  ...
  function handleExitClick() {
    ...
    else router.push('/app/campagnes/campaigns');
  }
    ...
    try {
      ...
      if (launch) {
        ...
        if (!sendRes.ok) {
          ...
          router.push(`/app/campagnes/campaigns/${campaignId}`);
          return;
        }
      }
  ...
  if (authState === 'no-admin') return <NoAdminScreen email={currentEmail} signOut={async () => { await supabase.auth.signOut(); router.push('/login?return=/app/campagnes/campaigns/new'); }} />;
    ...
    return (
      <div className="min-h-screen bg-surface-base text-content-primary p-4 sm:p-8">
        <div className="max-w-2xl mx-auto pt-12">
          <Link href="/app/campagnes/campaigns" className="inline-flex items-center gap-2 text-sm text-content-tertiary hover:text-violet-400 transition mb-4">
            <ArrowLeft size={14} />
            Campagnes
          </Link>
          <div className="rounded-2xl border border-amber-400/30 bg-amber-500/5 p-8 text-center">
            ...
            <Link href="/app/campagnes" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-violet-600 hover:bg-violet-500 text-white text-sm font-semibold transition shadow-lg shadow-violet-500/20">
              <Users size={14} />
              Créer une liste
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-surface-base text-content-primary">
      ...
      <ConfirmModal
        ...
        onConfirm={() => {
          ...
          router.push('/app/campagnes/campaigns');
        }}
  ...
  return (
    <div className="min-h-screen bg-surface-base flex items-center justify-center p-6">
      <div className="max-w-md w-full rounded-2xl border border-line bg-surface-card p-8 text-center">
        ...
        <Link href="/login?return=/app/campagnes/campaigns/new" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-violet-600 hover:bg-violet-500 text-white text-sm font-semibold transition">
          <LogIn size={14} />
          Se connecter
        </Link>
      </div>
