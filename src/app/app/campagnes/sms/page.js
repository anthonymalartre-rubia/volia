                  ...
                  return (
                    <tr key={c.id} className="border-t border-line hover:bg-surface-elevated/50 transition group">
                      <td className="px-4 py-3">
                        <Link href={`/app/campagnes/sms/${c.id}`} className="block group-hover:text-emerald-400 transition">
                      ...
                      <td className="px-4 py-3 text-right">
                        <Link href={`/app/campagnes/sms/${c.id}`} className="inline-flex items-center gap-1 text-content-tertiary group-hover:text-emerald-400 transition">
