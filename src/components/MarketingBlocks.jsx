...
const BUILT_FOR_PROFILES = [
  ...
  },
  {
    ...
    pitch: 'Validez votre PMF avant d\'embaucher un SDR. La suite complète gratuite pour démarrer, Prospection dès 19 €/mois.',
  ...
  },
  {
    ...
    pitch: 'Plan Prospection à 19 €/mois — 500 emails + 500 téléphones chaque mois. Pas d\'engagement.',
    metric: 'Dès 19 €/mois',
