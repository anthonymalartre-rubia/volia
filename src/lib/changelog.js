...
const CHANGELOG = [
  {
    date: '2026-06-11',
    version: '5.1',
    title: 'Nouveau modèle : freemium + crédits + plan MAX',
    items: [
      ...
      { type: 'feature', tag: 'Tarifs', text: 'Plan MAX à 179 €/mois : Volia One en mode Autopilot 24/7 + suite complète + équipes + serveur MCP. Code MAX99 : les 3 premiers mois à 99 €.' },
  ...
  },
  {
    ...
    items: [
      { type: 'feature', tag: 'Nouveau module', text: 'Volia Project : gestion de projets de livraison. Kanban 3 colonnes, ajout de tâche en tapant Entrée, jalons ⭐, vue liste.' },
