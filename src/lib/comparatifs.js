...
export const COMPARATIFS = {
  ...
  'apollo-vs-volia': {
    ...
    tldr: [
      "Sur les tarifs affichés, Volia est nettement moins chère qu'Apollo en France (Prospection 19 €/mois vs 49 $/mois Basic, et MAX 179 €/mois pour toute l'équipe vs 99 $/mois par siège Professional).",
    ...
    chiffresCles: [
      { label: 'Prix d\'entrée', apollo: '49 $/mo (Basic)', volia: '19 €/mo (Prospection)', voliaWins: true },
      { label: 'Prix volume (crédits)', apollo: '99 $/mo (~92 €)', volia: '19 €/mo + packs crédits dès 9 €', voliaWins: true },
      { label: 'Prix scale / suite', apollo: '149 $/mo + emails illimités', volia: '179 €/mo (MAX, suite illimitée)', voliaWins: null, note: 'Apollo facture par siège ; Volia MAX est par compte, toute l\'équipe incluse.' },
      { label: 'Plan gratuit', apollo: '60 crédits/mois', volia: 'Toute la suite + 25 crédits/mois', voliaWins: true },
    ...
    features: [
      ...
      { label: 'API publique', apollo: 'yes', volia: 'yes', note: 'Volia : API publique incluse dès Prospection (19 €/mo) + Zapier/Make.' },
      ...
      { label: 'Séquences email automatisées', apollo: 'yes', volia: 'yes', note: 'Volia : module Campagnes (inclus dès le plan Gratuit, illimité avec MAX).' },
      ...
      { label: 'Onboarding gratuit', apollo: 'no', volia: 'yes', note: 'Volia : appel onboarding 30 min offert (plans payants).' },
    ...
    analyses: [
      {
        ...
        body: "Apollo annonce fièrement 220 millions de contacts mondiaux. C'est vrai. Mais dans le détail, sa base française est constituée majoritairement de profils LinkedIn scrapés, avec une fraîcheur souvent supérieure à 18 mois. Sur les PME (TPE + ETI), la couverture réelle plafonne autour de 40 % — testez vous-même : cherchez \"boulangerie Lille\" sur Apollo, vous remonterez 8-12 résultats. Sur Volia, vous en aurez 200+, sourcés via Google Places (mis à jour quotidiennement par les commerçants eux-mêmes). Volia n'a pas la profondeur mondiale d'Apollo, mais sur la France elle gagne sur le terrain : tout le tissu B2B français, ~46 % de couverture sur les PME, et un waterfall qui va chercher l'email là où Apollo abandonne (scraping du site puis Google via Serper avant le pattern guessing). Pour cibler la France, Volia est mathématiquement meilleur. Pour cibler l'international, Apollo reste devant.",
      },
      {
    ...
    personas: [
      {
        ...
        after: 'Volia Prospection 19 €/mois — 500 crédits/mois, exports illimités',
        savings: '27 €/mois (~325 €/an) + waterfall 7 sources',
        verdict: 'Volia Prospection. Vous payez moins de la moitié du prix pour 8× plus d\'emails trouvés chaque mois. Aucun débat.',
      },
      {
        title: 'Vous êtes une agence growth 5 personnes',
        before: 'Apollo Professional 99 $/mo (~92 €) × 5 sièges ≈ 460 €/mo',
        after: 'Volia MAX 179 €/mois — suite illimitée (Prospection + Campagnes), toute l\'équipe',
        savings: '~280 €/mois + cadenceur intégré — et 3 mois à 99 € avec le code MAX99',
        verdict: 'Volia MAX. Vous gagnez prospection + cadence dans un seul outil français, pour moins de 2 sièges Apollo.',
      },
      {
        title: 'Vous êtes une startup avec une équipe sales 3 BDR',
        before: 'Apollo Custom (~250 €/mois mini contrat annuel) + Salesforce',
        after: 'Volia MAX 179 €/mois — suite illimitée + Autopilot + CRM (à venir)',
        savings: '~70 €/mois + zéro engagement annuel',
        verdict: 'Volia MAX. Sauf si vous êtes 100 % sous Salesforce avec sync 2-way obligatoire (auquel cas Apollo reste plus mature).',
      },
    ],
    migration: {
      ...
      steps: [
        ...
        {
          title: 'Créer votre compte Volia (plan Gratuit)',
          time: '2 min',
          desc: 'volia.fr/signup → email pro ou Google OAuth. Aucune carte bancaire demandée : plan Gratuit à vie (toute la suite + 25 crédits/mois) et 14 jours d\'essai MAX inclus. Vous pouvez passer à Prospection (19 €/mois) ou MAX plus tard depuis le dashboard.',
        },
        {
      ...
      faqMigration: [
        ...
        { q: 'Combien coûte la migration ?', a: 'Gratuite. Volia ne fait pas payer l\'import CSV ni l\'onboarding (offert sur les plans payants — Prospection 19 €/mois et MAX).' },
      ],
    },
    temoignage: {
    ...
    faq: [
      { q: 'Volia est-il vraiment moins cher qu\'Apollo à fonctionnalités égales ?', a: 'Oui — et la différence est marquée. Le plan Prospection Volia (19 €/mo, 500 crédits/mois) équivaut grossièrement au plan Basic Apollo (49 $/mo, 60 crédits) avec 8× plus de volume mensuel pour moins de la moitié du prix. Volia MAX (179 €/mo, suite illimitée + cadenceur, toute l\'équipe) remplace Apollo Professional (99 $/mo par siège, ~92 €) dès 2 sièges. Sur 12 mois, l\'économie moyenne pour un freelance est de ~320 €, et pour une équipe growth 3-5 personnes de plus de 1 100 €.' },
      ...
      { q: 'Volia a-t-il un essai gratuit aussi long qu\'Apollo ?', a: 'Volia propose un plan Gratuit à vie (toute la suite avec limites + 25 crédits/mois, sans carte bancaire), plus 14 jours d\'essai MAX sans CB. Apollo propose un free trial avec 60 crédits one-time, puis force le passage payant. Donc oui : Volia est plus généreux sur le free, et sur la durée.' },
      ...
      { q: 'Volia est-il aussi fiable qu\'Apollo (uptime, support) ?', a: 'Uptime Volia : 99,9 % sur les 12 derniers mois (page status publique : volia.fr/status). Hébergé sur Vercel EU (Frankfurt) + Supabase EU avec failover automatique. Support FR garanti < 24 h sur les plans payants (prioritaire sur MAX), vs Apollo qui répond en 8-12 h en anglais (fuseau PST). Sur la fiabilité technique, parité. Sur le support : Volia gagne.' },
      { q: 'Quelle solution pour une grosse équipe (20+ users) ?', a: 'À partir de 20 sièges, Apollo Custom devient compétitif (négociation directe, intent data inclus). Volia MAX à 179 €/mois inclut les équipes / multi-utilisateurs et l\'API publique — facturé par compte, pas par siège. Notre recommandation : équipes < 15 → Volia MAX ; équipes 20+ avec besoin d\'intent data → Apollo Custom.' },
      { q: 'Comparatif side-by-side : où Volia gagne clairement ?', a: 'Prix (-50 à -80 %), couverture France (78 % vs 40 %), recherche par catégorie + département FR, waterfall multi-sources (économie de crédits), conformité RGPD native, support français, hébergement EU, plan Gratuit généreux, intégration Zoho CRM + Brevo + Mailjet.' },
    ...
    verdict: {
      voliaWins: ['Prix (2-5× moins cher)', 'Couverture France (78 % vs 40 %)', 'Support en français', 'Conformité RGPD native', 'Suite intégrée Prospection + Campagnes (+ CRM bientôt)', 'Plan gratuit généreux (toute la suite + 25 crédits/mois à vie)'],
  ...
  'lemlist-vs-volia': {
    ...
    hero: {
      ...
      subtitle: "Lemlist est le premier cadenceur français premium (59 €/mo). Volia Campagnes propose le même cadenceur — inclus dès le plan Gratuit, avec la prospection intégrée dès 19 €/mo et la suite illimitée à 179 €/mo (MAX, toute l'équipe). Économie typique : 300 €/mois pour une agence 5 personnes. Comparatif sans complaisance.",
      ctaPrimary: { label: 'Essayer Volia gratuitement', href: '/signup?plan=starter' },
      ctaSecondary: { label: 'Voir le tableau comparatif', href: '#comparatif-features' },
    },
    tldr: [
      ...
      "Volia inclut le cadenceur Campagnes + la prospection + bientôt CRM : gratuit pour démarrer (200 cold emails/mois), prospection dès 19 €/mo, suite illimitée à 179 €/mo avec MAX (vs Lemlist 59 €/mo cadenceur seul).",
    ...
    chiffresCles: [
      { label: 'Prix d\'entrée cadenceur', apollo: '59 €/mo (Email Starter)', volia: '0 € (200 emails/mois inclus)', voliaWins: true },
      { label: 'Prix illimité', apollo: '99 €/mo (Email Pro, par siège)', volia: '179 €/mo (MAX, toute l\'équipe)', voliaWins: true, note: 'Lemlist facture par siège ; MAX est par compte — dès 2 users, MAX gagne.' },
      { label: 'Prix Enterprise multicanal', apollo: '159 €/mo (Multichannel, par siège)', volia: '179 €/mo (MAX, par compte)', voliaWins: null },
      { label: 'Plan gratuit', apollo: '14 j trial', volia: 'Suite complète gratuite à vie (limites)', voliaWins: true },
    ...
    features: [
      ...
      { label: 'API publique', apollo: 'yes', volia: 'yes', note: 'Volia : API publique incluse dès Prospection (19 €/mo).' },
      ...
      { label: 'Onboarding gratuit', apollo: 'partial', volia: 'yes', note: 'Lemlist : onboarding only sur Multichannel 159 €/mo. Volia : offert sur les plans payants.' },
    ...
    analyses: [
      ...
      },
      {
        ...
        body: "Lemlist Email Starter : 59 €/mo pour le cadenceur seul. Email Pro : 99 €/mo (+ Lemcal). Multichannel : 159 €/mo (+ LinkedIn). Ajoutez Hunter (49 $) ou Dropcontact (31 €) pour la découverte → coût réel 90 à 190 €/mo pour la stack complète. Volia Prospection : 19 €/mo, 500 crédits/mois + waterfall 7 sources, avec le cadenceur Campagnes inclus dès le plan Gratuit (200 emails/mois). Volia MAX : 179 €/mo, suite illimitée — 10 000 cold emails/mois + warmup auto + CRM (à venir), pour toute l'équipe. Pour une agence growth 5 personnes : Lemlist Email Pro × 5 sièges ≈ 495 €/mo (et c'est par siège), Volia MAX 1 compte = 179 €/mo. L'écart est massif. Sauf cas spécifique (besoin Lemwarm absolu OU LinkedIn outreach hardcore), Volia gagne sur le total cost.",
      },
    ],
    personas: [
      {
        ...
        after: 'Volia Prospection 19 €/mo — cadenceur inclus dès le Gratuit + packs crédits dès 9 € si volume',
        savings: '~70 €/mois (~850 €/an) + tout en 1 outil',
        verdict: 'Volia Prospection. Sauf si Lemwarm est non-négociable pour vous (cold email pur sur emails froids inconnus).',
      },
      {
        title: 'Vous êtes une agence growth 5 personnes',
        before: 'Lemlist Email Pro 99 €/mo × 5 sièges = 495 €/mo + Hunter 49 $',
        after: 'Volia MAX 179 €/mo (1 compte, toute l\'équipe) — séquences illimitées + 2 000 crédits/mois',
        savings: '~360 €/mois (~4 300 €/an) — record du comparatif',
        verdict: 'Volia MAX (code MAX99 : 3 premiers mois à 99 €). Le modèle "par compte" vs "par siège" change tout pour une agence. Vous gardez Lemlist en backup uniquement si workflows complexes hérités.',
      },
      {
        title: 'Vous êtes une startup B2B SaaS avec 3 BDR',
        before: 'Lemlist Multichannel 159 €/mo × 3 sièges = 477 €/mo + Apollo (~150 €)',
        after: 'Volia MAX 179 €/mo — suite illimitée + Autopilot + CRM bientôt',
        savings: '~450 €/mois (~5 400 €/an)',
        verdict: 'Volia MAX. Si vous avez vraiment besoin du LinkedIn natif Lemlist (cible tech / SaaS), restez sur Lemlist Multichannel SEULEMENT pour ça, et utilisez Volia pour la prospection FR + emailing complémentaire.',
      },
    ],
    migration: {
      ...
      steps: [
        ...
        },
        {
          ...
          time: '2 min',
          desc: 'volia.fr/signup → plan Gratuit pour tester (14 jours d\'essai MAX inclus, sans CB), ou Prospection 19 €/mo directement si vous savez que vous migrerez (recommandé : prenez le mensuel pour la transition, pas l\'annuel).',
        },
        {
    ...
    temoignage: {
      quote: "On était sur Lemlist Email Pro à 99 €/mois × 4 sièges = 396 €. Plus Dropcontact à 31 €. Total : 427 €/mois pour faire de l'outbound. On a migré sur Volia MAX à 179 €/mois — TOUT compris, équipe entière, prospection + cadence + enrichissement illimités. Économie : 248 €/mois, soit 2 976 €/an. Les délivrabilités sont équivalentes (on était déjà warm), et le support FR de Volia est honnêtement meilleur. Aucun regret.",
      author: 'Thomas Lecomte',
      role: 'CEO, Agence Growth Bordeaux',
      avatar: 'TL',
      avatarGradient: 'from-blue-500 to-sky-600',
      metric: '-248 €/mois',
      metricLabel: 'soit 2 976 €/an d\'économies',
    },
    faq: [
      { q: 'Volia est-il vraiment moins cher que Lemlist à fonctionnalités égales ?', a: 'Pour le cadenceur pur, le plan Gratuit Volia inclut déjà 200 cold emails/mois — et Volia MAX (179 €/mo) débloque 10 000 emails/mois + warmup pour toute l\'équipe, là où Lemlist Email Starter (59 €/mo) reste un cadenceur seul, facturé par siège. Pour le Multichannel (LinkedIn + email), Lemlist à 159 €/mo garde l\'avantage prix en solo SI vous avez vraiment besoin du LinkedIn natif. Pour les agences (par compte vs par siège), l\'écart explose en faveur de Volia : 179 €/mo Volia MAX 1 compte vs 495 €/mo Lemlist 5 sièges Email Pro.' },
      ...
      { q: 'Volia a-t-il un essai gratuit aussi long que Lemlist ?', a: 'Volia propose un plan Gratuit à vie (toute la suite avec limites, dont 200 cold emails/mois, sans CB) + 14 jours d\'essai MAX sans CB. Lemlist propose un free trial de 14 jours, puis force le passage payant. Sur la durée, Volia est plus généreux.' },
      ...
      { q: 'Quelle solution pour une grosse équipe (20+ users) ?', a: 'Lemlist devient prohibitif (159 €/mo × 20 sièges = 3 180 €/mo Multichannel). Volia MAX 179 €/mo est par compte et inclut les équipes / multi-utilisateurs — pas de coût par siège. Pour 20+ users actifs en outbound : Volia MAX, sauf si le LinkedIn natif par siège est indispensable.' },
    ...
    verdict: {
      voliaWins: ['Prix total (-50 à -85 %)', 'Modèle par compte (vs par siège Lemlist)', 'Prospection intégrée (Lemlist en a 0)', 'Enrichissement waterfall inclus', 'SMS outbound natif', 'Plan gratuit à vie (suite complète avec limites)'],
  ...
  'hubspot-vs-volia': {
    ...
    hero: {
      ...
      subtitle: "HubSpot Starter facture 90 €/mois par utilisateur pour son Sales Hub — sans prospection ni cadenceur sérieux inclus. Volia propose la suite complète illimitée (prospection + campagnes + CRM bientôt) à 179 €/mo (MAX) pour toute l'équipe. Économie typique : 250-400 €/mois pour une PME 5 personnes. Analyse approfondie.",
      ctaPrimary: { label: 'Essayer Volia gratuitement', href: '/signup?plan=starter' },
      ctaSecondary: { label: 'Voir le tableau comparatif', href: '#comparatif-features' },
    },
    tldr: [
      "HubSpot Starter est facturé par utilisateur : 90 €/mo/user pour Sales Hub Starter, 450 €/mo/user pour Pro. Volia est par compte : 179 €/mo (MAX) pour toute l'équipe.",
    ...
    chiffresCles: [
      { label: 'Prix CRM gratuit', apollo: '✓ Free CRM (limité)', volia: '✓ plan Gratuit (suite + CRM)', voliaWins: null },
      { label: 'Prix entry Sales', apollo: '20 €/mo/user (Sales Starter)', volia: '19 €/mo (Prospection, par compte)', voliaWins: true },
      { label: 'Prix Pro', apollo: '90 €/mo/user (Sales Pro)', volia: '179 €/mo (MAX, toute l\'équipe)', voliaWins: true, note: 'Dès 2 users, MAX est moins cher — et sans minimum de sièges.' },
      { label: 'Prix Suite complète', apollo: '~1 200 €/mo (Pro 5 users)', volia: '179 €/mo (MAX)', voliaWins: true },
      ...
      { label: 'Cadenceur cold email', apollo: 'partial (Sequences Pro+)', volia: '✓ Campagnes (dès le Gratuit)', voliaWins: true },
    ...
    personas: [
      {
        ...
        after: 'Volia Prospection 19 €/mo (le cadenceur Campagnes est inclus dès le plan Gratuit)',
        savings: '~90 €/mois',
        verdict: 'Volia Prospection. HubSpot Starter est sous-équipé en cadenceur, vous finirez par payer Sales Pro = explosion budget.',
      },
      {
        ...
        after: 'Volia MAX 179 €/mo (toute équipe, suite illimitée + CRM beta) — 3 mois à 99 € avec MAX99',
        savings: '~270 €/mois (~3 250 €/an) + zéro onboarding payant + zéro engagement',
        verdict: 'Volia MAX. Si vous avez besoin d\'un CRM mature MAINTENANT, attendez Volia CRM Q3 2026 ou utilisez HubSpot CRM gratuit + Volia MAX pour le reste.',
      },
      {
        ...
        after: 'Volia MAX 179 €/mo + Brevo 25 €/mo pour newsletters = 204 €/mo',
        savings: '~355 €/mois (~4 250 €/an)',
        verdict: 'Volia MAX + outils complémentaires légers. Sauf si votre stratégie repose lourdement sur l\'inbound marketing automation, auquel cas HubSpot Marketing Pro garde une avance.',
      },
    ],
    migration: {
      ...
      steps: [
        ...
        },
        {
          title: 'Créer votre compte Volia',
          time: '2 min',
          desc: 'volia.fr/signup → MAX 179 €/mo (recommandé pour les PME ex-HubSpot : suite illimitée, CRM beta + multi-user, code MAX99 = 3 mois à 99 €) ou Prospection 19 €/mo si vous n\'avez besoin que de la prospection. Mensuel d\'abord pendant la transition.',
        },
        {
          title: 'Importer contacts dans Volia',
          time: '15 min',
          desc: 'Dashboard Volia → Listes → Importer CSV HubSpot. Volia détecte les colonnes auto (email, phone, company) et déduplique. Mapping custom fields possible. Les contacts importés ne consomment aucun crédit prospection.',
        },
        {
        ...
        },
        {
          ...
          time: '1-2 h',
          desc: 'Pour les besoins non couverts par Volia : Brevo (newsletters & marketing automation simple : 25 €/mo), Crisp (live chat : gratuit ou 25 €/mo), Plausible/Matomo (analytics RGPD : 9 €/mo). Coût total stack post-migration : ~200-240 €/mo vs 800-1 500 €/mo HubSpot.',
        },
        {
    ...
    temoignage: {
      quote: "On était sur HubSpot Sales Pro à 90 €/mo × 6 users = 540 €/mois. Plus l'engagement annuel + 2 800 € d'onboarding obligatoire. On a fait l'audit : on n'utilisait QUE le CRM basique + les sequences. On a migré sur Volia MAX 179 €/mo + on garde HubSpot CRM Free en archive. Économie : 361 €/mois, soit 4 332 €/an. Plus 2 800 € d'onboarding évités sur le renouvellement. Le seul truc qu'on a perdu : les rapports d'attribution multi-touch — on s'en passe très bien.",
    ...
    faq: [
      { q: 'Volia est-il vraiment moins cher que HubSpot à fonctionnalités égales ?', a: 'Sur le périmètre Sales (prospection + cadence + CRM basique), oui — massivement. Volia MAX 179 €/mo (toute équipe, suite illimitée) vs HubSpot Sales Pro 90 €/mo/user × 5 users mini = 450 €/mo. Économie de 60 % — et dès 19 €/mo (Prospection) si vous n\'avez besoin que de la prospection. Sur le périmètre Marketing complet (automation nurturing + landing pages + attribution), HubSpot reste plus complet — mais c\'est un autre besoin que Volia ne prétend pas couvrir aujourd\'hui.' },
      ...
      { q: 'Volia a-t-il un essai gratuit aussi long que HubSpot ?', a: 'Volia : plan Gratuit à VIE (toute la suite avec limites — prospection, campagnes, CRM, formulaires — sans CB), plus 14 jours d\'essai MAX sans CB. HubSpot : Free CRM à vie (1M contacts mais sans sequences, sans automation, sans email marketing). Les deux ont un plan free généreux. Volia est plus utile out-of-the-box pour démarrer l\'outbound (prospection incluse), HubSpot est plus utile pour le CRM mature pur.' },
      ...
      { q: 'Quelle solution pour une grosse équipe (20+ users) ?', a: 'À ce niveau, HubSpot devient une décision stratégique : Sales Hub Enterprise (1 200 €/mo/user) + Marketing Hub Enterprise (3 600 €/mo) = 100 000-300 000 €/an. Volia MAX 179 €/mo est par compte et inclut les équipes / multi-utilisateurs en illimité. Pour 20+ users tout de suite avec workflows enterprise complexes : HubSpot reste le standard. Pour 20+ users en mode léger : Volia MAX.' },
      { q: 'Comparatif side-by-side : où Volia gagne clairement ?', a: 'Prix (-60 à -85 % typique), modèle par compte (massif vs par user HubSpot), prospection intégrée (HubSpot 0), zéro engagement annuel, zéro onboarding payant obligatoire, support FR tous plans, RGPD by-design (HubSpot data center EU uniquement Pro+).' },
    ...
    verdict: {
      voliaWins: ['Prix total (-60 à -85 %)', 'Modèle par compte (vs par user HubSpot)', 'Prospection intégrée (HubSpot en a 0)', 'Zéro onboarding payant obligatoire', 'Zéro engagement annuel — annulation 1 clic', 'Support FR tous plans (HubSpot : Pro+ uniquement)'],
