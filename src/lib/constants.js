...
// ─── B2B Categories (grouped by sector) ────────────────────────────
export const B2B_GROUPS = {
...
export const B2B_CATS = Object.values(B2B_GROUPS).flat();

// ─── Copropriété Categories (grouped by type) ────────────────────────────
export const COPRO_GROUPS = {
  "Syndics & Gestion": [
  ...
  "Expertise & Conseil": [
    "expert immobilier copropriété",
    "diagnostiqueur copropriété",
    "conseil syndical",
    "audit copropriété",
    "courtier syndic",
    "avocat copropriété",
  ...
  "Entretien & Services": [
    ...
    "étanchéité toiture",
    "plombier copropriété",
    "électricien parties communes",
    "chauffage collectif",
...
// Flat array for backward compatibility
export const COPRO_CATS = Object.values(COPRO_GROUPS).flat();
