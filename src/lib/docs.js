...
export const DOCS_CATEGORIES = [
  {
    id: 'getting-started',
    label: 'Premiers pas',
    description: 'Créer son compte, premiers réflexes Volia.',
    icon: 'Rocket',
    color: 'violet',
  },
  {
    id: 'prospection',
    label: 'Prospection',
    description: 'Trouver des leads B2B avec Volia Prospection.',
    icon: 'Search',
    color: 'violet',
  },
  {
    ...
    description: 'Envoyer des séquences cold email qui convertissent.',
    icon: 'Mail',
    color: 'blue',
  },
  {
    id: 'crm',
    label: 'CRM',
    description: 'Pipelines, deals et activités natifs Volia.',
    icon: 'KanbanSquare',
    color: 'emerald',
  },
  {
    ...
    description: 'API publique, webhooks, Zapier, Make.',
    icon: 'Plug',
    color: 'amber',
  },
  {
    ...
    description: 'Plans, abonnement Stripe, RGPD, suppression.',
    icon: 'CreditCard',
    color: 'zinc',
  },
];
