...
const PERSONAS = {
  'sdr': {
    ...
    metaDescription: 'Toi, SDR, tu passes 60% de ton temps à chercher des contacts au lieu de prospecter. Volia te file 50 à 500 prospects qualifiés par jour, à exporter direct dans ton CRM. Gratuit pour tester, 19€/mois pour scaler. Tu te poses encore la question ?',
    ...
    idealPlan: { name: 'Prospection', price: '19', why: '500 crédits/mois + 500 téléphones + 2 000 recherches, cascade waterfall 7 sources, exports illimités. Et des packs de crédits dès 9€ pour les gros mois.' },
  ...
  'fondateurs': {
    ...
    metaDescription: 'Toi, fondateur sans SDR, tu galères entre Apollo à 99$/mois et le sourcing à la main. Volia : 500 emails de prospects qualifiés à 19€/mois, sans engagement, lancement en 5 min. Tu te poses encore la question ?',
    badge: 'Pour les fondateurs early-stage',
    h1: 'La prospection pour les fondateurs qui n\'ont pas (encore) de SDR',
    intro: 'Toi, fondateur, tu dois prospecter MAIS aussi développer le produit, gérer la finance, recruter. Avant d\'embaucher un SDR à 50K€/an, prouve ton PMF avec de la vraie prospection. Volia te trouve 500 emails de prospects qualifiés pour 19€/mois — et tu démarres gratuitement. Tu exportes ou tu contactes direct depuis l\'app.',
    ...
    idealPlan: { name: 'Prospection', price: '19', why: '500 crédits + 500 téléphones/mois, cascade waterfall 7 sources. Parfait pour valider ton marché avant de scaler.' },
    testimonialSector: 'Technologie & Digital',
  ...
  'agences-web': {
    ...
    idealPlan: { name: 'Prospection', price: '19', why: '500 crédits/mois + 2 000 recherches. Tu tapes 3-4 secteurs/villes en parallèle, et un pack de crédits dès 9€ si le pipe explose.' },
    testimonialSector: 'Technologie & Digital',
  ...
  'cabinets-rh': {
    ...
    idealPlan: { name: 'Prospection', price: '19', why: '500 crédits/mois + 500 téléphones. Tu couvres 2-3 secteurs verticaux complets — packs de crédits dès 9€ pour les gros mois.' },
  ...
  'freelances': {
    ...
    metaDescription: 'Toi, freelance, Malt te prend 15% de commission et te met en concurrence sur le prix. Volia : 19€/mois, sans engagement, 500 emails + 500 téléphones de prospects chaque mois. Adieu Malt, bonjour le client direct.',
    ...
    idealPlan: { name: 'Prospection', price: '19', why: '500 crédits + 500 téléphones/mois. Largement pour un freelance qui veut juste son carnet plein.' },
    testimonialSector: 'Technologie & Digital',
  ...
  'sales-managers': {
    ...
    metaDescription: 'Toi, Sales Manager, t\'as 10 SDR à équiper sans exploser le budget. Apollo + Outreach + ZoomInfo = 1 200€/SDR/mois. Volia MAX = 179€/mois pour toute l\'équipe (3 mois à 99€ avec MAX99). 98% d\'économie. Tu te poses encore la question ?',
    badge: 'Pour les Sales Managers',
    h1: 'Équipe ton équipe sales avec le meilleur ratio coût/résultats',
    intro: 'Toi, Sales Manager, tu diriges 5 à 50 SDR. Tu veux les équiper d\'un outil de prospection puissant SANS exploser le budget de ton CFO. Apollo + Outreach + ZoomInfo = 800-1 500€ par SDR par mois. Volia MAX coûte 179€/mois pour TOUTE l\'équipe — multi-utilisateurs inclus, 3 premiers mois à 99€ avec le code MAX99. Tu te poses encore la question ?',
    keyMetric: { value: '98%', label: 'd\'économie', sub: 'vs Apollo Pro Suite pour 10 SDR' },
    painPoints: [
