...
const TESTIMONIALS = [
  {
    ...
    content: 'On utilisait Apollo : 40 % de couverture en France, beaucoup d\'emails périmés. Avec Prospectia on monte à 78 % sur le 75 et 92, c\'est concret. Le ROI s\'est fait en 2 semaines.',
    location: 'Paris',
    rating: 5,
  },
  {
  ...
  },
  {
    ...
    sector: 'Technologie & Digital',
    content: 'Mes 4 SDR sortent 3× plus de leads qualifiés depuis qu\'on a basculé sur Prospectia. L\'export CSV importable direct dans HubSpot sans transformation, c\'est un game changer.',
    location: 'Lyon',
    rating: 5,
  },
  {
  ...
  },
  {
    ...
    sector: 'Immobilier',
    content: 'Sur les architectes et bureaux d\'études, Prospectia trouve les contacts directs des décideurs, pas les standards. Notre cycle commercial s\'est raccourci de 6 semaines à 3.',
    location: 'Lille',
    rating: 5,
  },
];
