const en = {
  ...
  verifier: {
    ...
    upgradeMsg: 'Email verification is included from the Prospecting plan (100/mo) — 5,000/mo on MAX.',
    upgradeBtn: 'Upgrade to Prospecting',
  ...
  upgrade: {
    ...
    upgradePro: 'Upgrade to Prospecting',
  },
  ...
  limitModal: {
    ...
    stoppedAt: 'The operation stopped at {{processed}} / {{total}}. {{remaining}} prospects left — upgrade to Prospecting (or grab a credit pack from €9) to continue right now.',
    proHeadline: 'Prospecting plan - 19 EUR/month',
    proBenefitEnrich1: '500 credits / month (emails found)',
    proBenefitEnrich2: '7-source waterfall cascade',
    proBenefitEnrich3: 'Export all formats, no cap',
    proBenefitSearch1: '2,000 searches / month',
    proBenefitSearch2: 'Natural language search included',
    proBenefitSearch3: 'Export all formats, no cap',
    upgradeCta: 'Upgrade to Prospecting — €19/month',
    dismiss: 'Later',
  },
  ...
  settings: {
    ...
    used: 'used',
    upgradeProPrompt: 'Upgrade to Prospecting — 500 credits/month, no more headaches.',
    upgradePro: 'Upgrade to Prospecting',
    ...
    upgradeToPro: 'Upgrade to Prospecting',
    ...
    hidePasswordForm: 'Cancel',
    nextRenewal: 'Renews on',
    daysAgo: 'days',
    accountSectionDesc: 'Login info and current plan',
    preferencesSectionDesc: 'Theme, language and privacy options',
    helpSectionDesc: 'Tutorials and documentation',
    language: 'Language',
  ...
  landing: {
    ...
    features: {
      label: 'Features',
      title: 'What you get for €19/month',
    ...
    pricing: {
      ...
      title: 'The cheapest on the market, per tier',
      desc: 'No hidden fees. Google search included. Free to start, Prospecting at EUR 19/mo.',
      perMonth: '/month',
      perYear: '/year',
      monthly: 'Monthly',
      yearly: 'Yearly',
      ...
      chooseSolo: 'Choose Prospecting',
      choosePro: 'Choose MAX',
      chooseBusiness: 'Choose MAX',
      ...
      businessTagline: 'For outbound teams',
      yearlySave: 'Yearly billing: Prospecting €190 (2 months free), MAX €1,690 (€458 saved).',
      questions: 'Questions about pricing?',
      contactSupport: 'Contact us',
    },
    // Freemium pivot (June 2026): free = Free, solo = Prospecting €19,
    // pro/business = MAX €179 (keys kept for i18n compatibility).
    planFeatures: {
      // Free = baseline. No inheritsFrom — it's the root plan.
      free: [
        '25 credits/month (emails found)',
        '5 exports/month',
        'Free email + phone scraping (landline & mobile)',
        '101 departments (all of France)',
      ],
      solo: [
        '500 credits/month + 500 phone numbers',
        'Unlimited exports',
        '7-source waterfall cascade — emails AND phones',
        'Public API + Zapier/Make',
      ],
      pro: [
