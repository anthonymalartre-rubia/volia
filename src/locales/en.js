const en = {
  ...
  limitModal: {
    ...
    proBenefitEnrich2: 'Full multi-source waterfall cascade access',
  ...
  landing: {
    ...
    pricing: {
      ...
      desc: 'No hidden credits. Google search included. Starting at EUR 19/mo.',
      perMonth: '/month',
      perYear: '/year',
      monthly: 'Monthly',
      yearly: 'Yearly',
      ...
      yearlySave: 'Save 2 months on every plan with yearly billing',
