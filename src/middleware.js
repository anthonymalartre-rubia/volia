...
export async function middleware(request) {
  ...
  const isPublicRoute =
    ...
    pathname.startsWith('/mentions-legales') ||   // Mentions légales (obligation LCEN)
    ...
    pathname === '/one' ||                    // Volia One — page publique (API run rate-limitée ; launch reste gardé)
    ...
    pathname.startsWith('/tutoriels') ||          // vidéos tutoriels
